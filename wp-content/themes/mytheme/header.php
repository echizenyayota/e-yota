...
<head prefix="og: http://ogp.me/ns#">
  <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-G7JRCBDCDB"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-G7JRCBDCDB');
  </script>
  <meta charset="utf-8">
  ...
  <?php endif; // カテゴリー・タグ用のここまで　?>
    ...
    <!-- Google Adsense 自動広告-->
    <script data-ad-client="ca-pub-4555449890300852" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
