...
class Social_Booster_Admin_Pages {
	...
	function socialbooster_add_admin_pages() {
		...
		add_submenu_page( 'socialbooster_autopost', 'Socialbooster instragram', 'Instragram','manage_options', 'socialbooster_instragram', array( $this, 'socialbooster_admin_insindex'));
